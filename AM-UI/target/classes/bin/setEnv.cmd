...
@set JAVA_VM=-XX:PermSize=64M -XX:MaxNewSize=256m -XX:MaxPermSize=128m -Djava.awt.headless=true -Xmx512m -Xms256m
...
@echo .
@unset %classpath%
@set classpath=%classpath%;%JAVA_HOME%/jre/lib/rt.jar;%DEPLOY_PATH%/resources
@echo %classpath%
