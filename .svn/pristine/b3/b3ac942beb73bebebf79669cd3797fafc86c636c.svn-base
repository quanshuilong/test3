 ...
 */
public abstract class BaseRestServerInterfaceImplNoDubbo<Entity extends TrackableEntity> implements BaseRestServerInterface {
...
//        String userName = (User)getRequest().getSession().getAttribute(Constants.user.COOKIE_USER);
    ...
    public String getPage(String jsonStr) {
        ...
        try {
            ...
            page = this.getBaseInterface().findByPage(page, mapBean);
    ...
    public String getAll() {
        String result = "";
        try {
            List<Entity> list = this.getBaseInterface().findAll();
    ...
    public String getByWhere(String jsonStr) {
        ...
        try {
            ...
            List<Entity> list = this.getBaseInterface().findByMap(mapBean);
            if (list != null) {
                result = JSON.toJSONStringWithDateFormat(list, "yyyy-MM-dd HH:mm:ss");
    ...
    public String getById(String id) {
        ...
        try {
            if (StringUtils.isNotBlank(id)) {
                Entity entity = this.getBaseInterface().findById(id);
                if (entity != null) {
    ...
    public String getByName(String name) {
        ...
        map.put("name", name);
        try {
            List<Entity> list = this.getBaseInterface().findByMap(map);
    ...
    public String deleteById(String id) {
        boolean flag = false;
        try {
            flag = this.getBaseInterface().deleteById(id);
    ...
    public String save(String jsonStr) {
        ...
        try {
            Entity entity = JSON.parseObject(jsonStr, this.getEntityClass());
            if (entity != null) {
                result = this.getBaseInterface().save(entity);
                jsonView.successPack(result);
    ...
    public String update(String jsonStr) {
        ...
        try {
            Entity entity = JSON.parseObject(jsonStr, this.getEntityClass());
            if (entity != null) {
                result = String.valueOf(this.getBaseInterface().update(entity));
                jsonView.successPack(result);
