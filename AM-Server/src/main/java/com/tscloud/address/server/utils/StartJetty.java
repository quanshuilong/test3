...
public class StartJetty {
    ...
    public void startJetty() {
        ...
        try {
            System.out.println("===========================================================");
            System.out.println("[" + DateUtil.getDateTime() + "] AM Server is starting......");
            server.start();
            System.out.println("[" + DateUtil.getDateTime() + "] AM Server has been started.");
            System.out.println("[" + DateUtil.getDateTime() + "] AM Server URL: http://" + InetAddress.getLocalHost().getHostAddress() + ":" + ConfigHelper.getJettyParameter("server.port") + ConfigHelper.getJettyParameter("server.name"));
            System.out.println("[" + DateUtil.getDateTime() + "] AM Server Start successfully.");
            System.out.println("===========================================================");
        } catch (Exception e) {
            e.printStackTrace();
        }
